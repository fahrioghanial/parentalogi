...
export default function Profil() {
  ...
  const handleSubmit = (e) => {
    ...
    const profile = {nama_pengguna, nama, bio, tanggal_lahir, domisili, pekerjaan };
    ...
    <>
      ...
      <section id="dashboard" className="pt-32 font-asap bg-white">
        <div className="container">
          <div className="ml-28">
            <p className="font-asap text-[#3980BF] mb-4 text-3xl">Setelan untuk <b>@ {oldUsername}</b></p>
          </div>
                  ...
                  <div className="py-6 px-6 bg-[#3980BF] text-white flex flex-col gap-2">
                    ...
                    <p className="font-medium text-xl">Email</p>
                      <input
                        ...
                        value= { email }
                        placeholder="Email"
                        className="p-2 rounded-md md:w-full w-0 text-black bg-slate-400"
                        readOnly
                      />
                    ...
                    <div className="flex flex-row" >
                      ...
                      />
                        <input
                          ...
                          id="photoBox"
                          placeholder="Photo"
                          className="ml-4 p-2 rounded-md md:w-full w-0 text-black bg-white"
                        />
                    </div>
                  </div>
                </div>
